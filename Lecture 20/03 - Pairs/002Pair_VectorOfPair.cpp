...
int main() {
	...
	sort(v6.begin(), v6.end()); // by default, a vector of pair is sorted in the increasing order based on the first element of the pair
	...
	sort(v6.begin(), v6.end(), comparator);
