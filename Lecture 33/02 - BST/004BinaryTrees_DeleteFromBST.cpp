...
TreeNode* deleteFromBST(TreeNode* root, int key) {
	...
	if (key == root->val) {
		...
		if (root->left == NULL and root->right == NULL) {
			...
			// the node we want to delete has a single right child
			...
			// the node we want to delete has a single left child
			...
			// the node we want to delete has two child nodes
		...
		// recursively, delete the key, if exists, from the leftSubtree
		...
		// recursively, delete the key, if exists, from the rightSubtree
