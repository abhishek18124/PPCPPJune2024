...
bool searchIteraive(ListNode* head, int target) {
	...
	return false; // target is not found in the linkedList
...
int main() {
	...
	searchIteraive(head, target) ? cout << "true" << endl : cout << "false" << endl;
