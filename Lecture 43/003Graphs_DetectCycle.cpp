		...
		for (T neighbour : neighbourList) {
			if (visited.find(neighbour) == visited.end()) {
				...
				if (dfsHelper(neighbour, visited, source)) {
					// you've found a cycle in the subcomponent therefore there is a cycle in the component
					return  true;
				}
				...
				// you've to check if source-neighbour is a backedge

				if (neighbour != parent) {

					// source-neighbour is a backedge therefore you've a cycle
